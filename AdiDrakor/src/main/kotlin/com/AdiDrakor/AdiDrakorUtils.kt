...
// ================== UTILITY FUNCTIONS (adapted from Adicinemax21Utils) ==================

/**
 * Dipakai di AdiDrakor.load() untuk menandai konten yang belum tayang.
 */
...
/**
 * Dipakai untuk mendapatkan nilai kualitas dari string nama resolusi (Adimoviebox, Adimoviebox2).
 */
...
/**
 * Fungsi Base64 untuk Adimoviebox2Helper di AdiDrakorExtractor.
 */
