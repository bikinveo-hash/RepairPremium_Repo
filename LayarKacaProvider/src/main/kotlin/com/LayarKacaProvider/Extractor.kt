...
// =========================================================================
// EXTRACTOR 4: HYDRAX (ABYSS) - PURE NATIVE AES-CTR (FINAL ANTI-ERROR)
// =========================================================================
open class HydraxExtractor : ExtractorApi() {
    ...
    override suspend fun getUrl(url: String, referer: String?): List<ExtractorLink>? {
        ...
        try {
            ...
            // Menggunakan ISO_8859_1 (Latin-1) agar data biner tidak cacat
            ...
            // Dekripsi menggunakan Java Cryptography murni
            ...
            // Fungsi lokal suspend untuk mengolah Map hasil dekripsi dengan for-loop
            suspend fun processSources(formatMap: Map<*, *>?, isHls: Boolean) {
            ...
            processSources(mediaData["hls"] as? Map<*, *>, true)
            processSources(mediaData["mp4"] as? Map<*, *>, false)
