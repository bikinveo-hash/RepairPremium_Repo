...
// =========================================================================
// DATA CLASSES UNTUK API CAST (BYSE / FILELION)
// =========================================================================
...
// Struktur JSON hasil dari Dekripsi AES-256-GCM
...
// =========================================================================
// MESIN EKSTRAKTOR MANDIRI UNTUK CAST HD (Anti-Bot Bypass)
// =========================================================================
        ...
        try {
            ...
            for (keyBytes in keysToTest) {
                try {
                    ...
                    if (realUrl != null) break // Lolos dan dapet link asli!
                } catch (e: Exception) {}
            }
