...
// FIX #10: Tambah default emptyList() agar tidak crash jika API mengembalikan results: null
data class TmdbResponse(
    @JsonProperty("results") val results: List<TmdbMovie> = emptyList()
)
...
data class TmdbDetailResponse(
    ...
    @JsonProperty("videos") val videos: TmdbVideoResult?,
    @JsonProperty("credits") val credits: TmdbCredits?,
    @JsonProperty("recommendations") val recommendations: TmdbRecommendations?,
...
data class TmdbSeasonDetail(
    @JsonProperty("episodes") val episodes: List<TmdbEpisodeDetail> = emptyList()
)
