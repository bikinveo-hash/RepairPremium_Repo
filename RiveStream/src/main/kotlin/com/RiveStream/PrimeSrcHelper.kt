...
class PrimeSrcHelper {
    ...
    companion object {
        // Array 70 string garam dinamis yang disuntikkan dari Next.js RiveStream
    ...
    // -------------------------------------------------------------------------
    // ENGINE GENERATOR SECRETKEY DINAMIS (PORTING DARI NEXT.JS GLOBAL CHUNK)
    // -------------------------------------------------------------------------
    ...
    suspend fun invokePrimeSrc(
        ...
        // Enkripsi Dinamis Berdasarkan TMDB ID Asli
        val secretKey = generateDynamicSecretKey(cleanId)

        // -------------------------------------------------------------------------
        // STRATEGI 1: Pemanenan Jalur Multi-Service Internal (Bypass total WebView)
        // -------------------------------------------------------------------------
